...
| 3 | 004 | [Full run history](docs/roadmap/004-full-run-history.md) | Done |
| 5 | 005 | [Unique relic tracking per run](docs/roadmap/005-unique-relic-tracking.md) | Designed |
...
| — | 008 | [Color-coded floor times in run history](docs/roadmap/008-color-coded-run-history.md) | Proposed |
